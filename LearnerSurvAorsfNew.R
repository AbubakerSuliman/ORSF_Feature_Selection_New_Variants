...
LearnerSurvAorsfNew = R6Class("LearnerSurvAorsfNew",
                              ...
                              public = list(
                                ...
                                initialize = function() {
                                  ps = ps(
                                    ...
                                    control_custom_fun = p_uty(custom_check = function(x) checkmate::checkFunction(x, nargs = 3), depends = control_type == "custom", tags = "train"),
                              ...
                              private = list(
                                .train = function(task) {
                                  ...
                                  pv = mlr3extralearners:::convert_ratio(pv, "mtry", "mtry_ratio",
                                  ...
                                  # browser()
                                  pv = mlr3misc::remove_named(pv, c("control_type",
                                ...
                                .predict = function(task) {
                                  ...
                                  surv = mlr3misc::invoke(predict,
                                                          self$model,
                                                          new_data = mlr3extralearners:::ordered_features(task, self),
                                                          pred_horizon = utime,
                                                          pred_type = "surv",
                                                          .args = pv
                                  )
